...
<iframe src="images/XOM_CVX_price_trend.html" width="100%" height="500" frameborder="0"></iframe>
...
|--------|-------|----------------|
| Pearson Correlation | 0.8532 | Strong positive correlation |
| Correlation Std Dev | 0.3195 | Moderate variability in correlation |
| Stability Score | -21.9450 | Correlation shows some instability |

<iframe src="images/XOM_CVX_rolling_corr.html" width="100%" height="500" frameborder="0"></iframe>
...
|------|-----------|---------------------|---------|--------|
| ADF Test | -2.8878 | -2.8654 | 0.0468 | Cointegrated ✓ |
| Johansen Trace | 19.3415 | 15.4943 | - | Cointegrated ✓ |

Both tests confirm the presence of cointegration, indicating that while XOM and CVX prices may diverge temporarily, they tend to revert to their long-term equilibrium relationship. The hedge ratio of 0.2015 suggests that for each share of XOM, approximately 0.20 shares of CVX should be traded in the opposite direction to create a market-neutral position.

<iframe src="images/XOM_CVX_spread.html" width="100%" height="500" frameborder="0"></iframe>
...
* **Half-Life**: 41.97 days (relatively long)
* **Maximum Holding Period**: 62 days (1.5× half-life)
...
<iframe src="images/XOM_CVX_zscore.html" width="100%" height="500" frameborder="0"></iframe>
...
<iframe src="images/XOM_CVX_market_value_curve.html" width="100%" height="500" frameborder="0"></iframe>

The market value curve above shows the growth of our initial $10,000 capital over the testing period. The steady upward trend demonstrates the consistent profitability of the strategy, reaching over $12,500 by the end of the period.
...
2. **Holding Periods**: Average holding period of 12.84 days, shorter than our calculated half-life (41.97 days).
...
### Profitability
* **Total Profit**: $2523.47
* **Average Profit per Trade**: $68.20
* **Profit Factor**: 1.96
:::
...
* **Average Win**: $178.04
* **Average Loss**: $-329.94
* **Average Holding Period**: 12.84 days
:::
:::
...
* **Final Equity**: $12,523.47
* **Alpha (annualized)**: 0.1071
* **Beta**: 0.0337
* **Geometric Mean Return (CAGR)**: 7.84%
:::
:::

::::

<iframe src="images/XOM_CVX_drawdown.html" width="100%" height="500" frameborder="0"></iframe>

The drawdown chart above shows the percentage decline from peak equity values throughout the testing period. The maximum drawdown of 8.82% is moderate and reflects the strategy's effective risk management, especially considering the volatile nature of energy stocks.

### Strategy Insights

Several key observations emerge from our trading results:

1. **High Win Rate**: The 78.38% win rate confirms the strong mean-reversion tendency between XOM and CVX, validating our statistical approach.

2. **Asymmetric Risk-Reward**: While average losses ($-329.94) are larger than average wins ($178.04), the high win rate more than compensates, resulting in a strong profit factor of 1.96.

3. **Reasonable Drawdowns**: The maximum drawdown of 8.82% is well within acceptable limits for a market-neutral strategy, indicating effective risk management.

4. **Efficient Holding Period**: Despite the relatively long half-life estimate (41.97 days), actual trades averaged just 12.84 days, suggesting that mean reversion often occurs faster than the statistical estimate.

5. **Risk-Adjusted Performance**: The Sharpe ratio (0.77) and particularly the Sortino ratio (0.85) demonstrate good risk-adjusted returns, with especially strong performance during downside market moves.

## Challenges and Considerations

While the overall performance is strong, several factors warrant attention:

1. **Correlation Stability**: The negative stability score (-21.9450) indicates significant variations in the correlation between XOM and CVX over time, which could introduce periods of strategy underperformance.
...
1. Using the established hedge ratio of 0.2010 to maintain market neutrality
